	...
	public class TreeIterator implements Iterator<T> {
		...
		public void goLeft() {
			try {
				...
				assert currentNode.left != null : "le butoir n'a pas de fil fis gauche";
		...
		public void goRight() {
			try {
				assert !this.isEmpty() : "le butoir n'a pas de fils";
				assert currentNode.right != null : "le butoir n'a pas de fils droit";
		...
		public NodeType nodeType() {
			if(!currentNode.isEmpty() ) {
				if(currentNode.left!=null && currentNode.right!=null) {
					stack.push(currentNode);
					currentNode = currentNode.left;
					//On Check le fils gauche
					if(nodeType() == NodeType.SENTINEL) {
						currentNode = stack.peek();
						currentNode = currentNode.right;
						//On check le fils droit
						if(nodeType() == NodeType.SENTINEL) {
						...
						//Si le fils gauche n'est pas un butoir
						currentNode = stack.peek();
						currentNode = currentNode.right;
						if(nodeType() == NodeType.SENTINEL) {
